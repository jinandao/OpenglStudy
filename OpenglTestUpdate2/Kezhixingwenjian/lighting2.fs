...
{                                                                                           
	...
	//return AmbientColor;
    return (AmbientColor*ShadowFactor*13 + 3*ShadowFactor * (DiffuseColor + SpecularColor));                  
}                                                                                           
